  ...
  public class AccountController : Controller {
    ...
    public async Task<ActionResult> ExternalLoginCallback(string returnUrl) {
      ...
      switch (claimsIdentity.GetUserId()) {
        case "818727": membershipName = "norbert-alice"; break;
        case "88421113": membershipName = "norbert-bob"; break;
      }
      if (!string.IsNullOrEmpty(membershipName)) {
        claimsIdentity.AddClaim(new Claim(claimsIdentity.RoleClaimType, "*"));
        claimsIdentity.AddClaim(new Claim(claimsIdentity.NameClaimType, membershipName));
      }
